...
import { formatApplicationDate, type ApplicationRecord } from '@/entities/application/model';
import { useDeleteApplication } from '@/features/application-data/useApplicationMutations';
import { EditApplicationDialog } from '@/pages/application-details/components/EditApplicationDialog';
