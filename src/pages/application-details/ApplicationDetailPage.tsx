...
import { ApplicationDetailHeader } from '@/pages/application-details/components/ApplicationDetailHeader';
import { ApplicationActivitySection } from '@/pages/application-details/sections/ApplicationActivitySection';
import { ApplicationDetailsSection } from '@/pages/application-details/sections/ApplicationDetailsSection';
import { ApplicationLinksSection } from '@/pages/application-details/sections/ApplicationLinksSection';
import { FitAnalysisSection } from '@/pages/application-details/sections/FitAnalysisSection';
import { JobDescriptionSection } from '@/pages/application-details/sections/JobDescriptionSection';
import { NotesSection } from '@/pages/application-details/sections/NotesSection';
