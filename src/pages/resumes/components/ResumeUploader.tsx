...
import { useUploadResume } from '@/features/resume-management/useResumes';
  ...
  return (
    <div className="w-full space-y-4">
      ...
      <label
        ...
        className="group flex min-h-52 cursor-pointer flex-col items-center justify-center rounded-xl border border-dashed border-primary/35 bg-primary/3 px-5 py-8 text-center transition-colors focus-within:border-ring focus-within:ring-3 focus-within:ring-ring/30 hover:border-primary/60 hover:bg-primary/[0.06] has-[:disabled]:pointer-events-none has-[:disabled]:opacity-70 motion-reduce:transition-none"
      >
