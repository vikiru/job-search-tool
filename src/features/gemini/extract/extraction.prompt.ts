...
Preserve the source's technical terms faithfully. Normalize capitalization and whitespace when clear, but do not silently correct, expand, or reinterpret an ambiguous or malformed term such as \`C/C+\`; keep the original term unless the source itself clearly provides the corrected form.
...
Remove job-board engagement and delivery metadata from any platform, including timestamps such as \`1 day ago\`, application counts such as \`37 people clicked apply\`, promotion labels such as \`Promoted by hirer\`, response-routing text such as \`Responses managed off LinkedIn\`, \`Easy Apply\`, \`Apply on company site\`, job-alert prompts, recruiter labels, and similar platform text. Remove standalone platform metadata lines such as \`Washington, United States · 1 day ago · 37 people clicked apply\` and \`Remote Full-time\` when they are generated by the platform rather than written as part of the employer's posting; those values are represented by structured fields. This rule is platform-agnostic and applies equally to LinkedIn, Workday, Greenhouse, Lever, company career sites, and other job trackers.

Preserve employer-provided values, inclusion, and employment-opportunity sections when they are included in the original posting, including sections named \`Our Employment Opportunities\`. Preserve source tags such as \`EARLYTECHTALENT\` when they appear as part of the posting rather than as unrelated page chrome. Remove separate \`Join our Talent Community\` promotions, generic recruitment slogans, and marketing links that are not specific to this application.
