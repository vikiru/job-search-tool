...
} from '@/features/application-data/types';
...
} from '@/features/application-data/application-schemas';
...
export type { CreateApplicationInput, UpdateApplicationInput } from '@/features/application-data/application-schemas';
