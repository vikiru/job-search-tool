...
import type { ApplicationDetail, ApplicationListItem } from '@/features/application-data/types';
...
} from '@/features/application-create/server';
...
} from '@/features/application-data/server';
